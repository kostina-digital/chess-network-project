...
"[project]/Projects/chess-network-project/src/app/login/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    if ($[0] !== "e389e772346c7dd74c395ad0e3d560326829584d19aeb5e30f134402ce2e3d51") {
        for(let $i = 0; $i < 22; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e389e772346c7dd74c395ad0e3d560326829584d19aeb5e30f134402ce2e3d51";
    }
    ...
    if ($[1] !== email || $[2] !== password || $[3] !== router) {
        t0 = async function handleSubmit(e) {
            ...
            const data = await res.json().catch(_LoginPageHandleSubmitAnonymous);
            if (!res.ok || !data?.ok) {
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$chess$2d$network$2d$project$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
            ...
            fileName: "[project]/Projects/chess-network-project/src/app/login/page.tsx",
            lineNumber: 53,
            columnNumber: 10
        }, this);
        $[5] = t1;
...
_s(LoginPage, "5gegbvPKNJSENPEOOlfMFtVzGKA=", false, function() {
    return [
...
_c = LoginPage;
function _LoginPageHandleSubmitAnonymous() {
    return null;
}
var _c;
...
//# sourceMappingURL=Projects_chess-network-project_src_app_login_page_tsx_0oh450f._.js.map